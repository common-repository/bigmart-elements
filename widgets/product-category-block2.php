 ...
 */
class Bigmart_Product_Category_Block2_Widget extends Widget_Base {

    /** Widget Name */
    public function get_name() {
        return 'bm-product-category-block2-widget';
    }

    /** Widget Title */
    public function get_title() {
        return __('Product Category Grid 2', 'bigmart-elements');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'category_1_heading', [
            'label' => __('Category 1', 'bigmart-pro'),
        ...
        $this->add_control(
                'product_category1', [
            'label' => __('Select Category', 'bigmart-elements'),
            'type' => Controls_Manager::SELECT,
            'default' => 0,
            'options' => bigmart_elements_get_woo_categories_list(),
                ]
        );

        $this->add_control(
                'category_image1', [
            'label' => __('Upload Image', 'bigmart-elements'),
        ...
        $this->add_control(
                'category_2_heading', [
            'label' => __('Category 2', 'bigmart-pro'),
            'type' => Controls_Manager::HEADING,
                ]
        );
        ...
        $this->add_control(
                'category_3_heading', [
            'label' => __('Category 3', 'bigmart-pro'),
            'type' => Controls_Manager::HEADING,
                ]
        );
        ...
        $this->add_control(
                'category_4_heading', [
            'label' => __('Category 4', 'bigmart-pro'),
            'type' => Controls_Manager::HEADING,
                ]
        );
        ...
        $this->add_control(
                'category_5_heading', [
            'label' => __('Category 5', 'bigmart-pro'),
            'type' => Controls_Manager::HEADING,
                ]
        );
        ...
        $this->add_control(
            ...
            'alpha' => true,
            'selectors' => [
                '{{WRAPPER}} .bm-product-category-block2.overlay .product-cat:before' => 'background: {{VALUE}}',
            ],
            'condition' => [
                'enable_overlay' => 'yes'
            ],
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .bm-product-category-block2 .cat-btn .ct-name' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => '{{WRAPPER}} .bm-product-category-block2 .cat-btn .ct-name',
                ]
        );
        ...
        $this->start_controls_section(
                'product_count_style', [
            'label' => __('Product Count', 'bigmart-elements'),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .bm-product-category-block2 .cat-btn .ct-pcount' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => __('Typography', 'bigmart-elements'),
            'selector' => '{{WRAPPER}} .bm-product-category-block2 .cat-btn .ct-pcount',
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .bm-product-category-block2 .cat-btn .ct-pcount' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        if (!$category1 && !$category2 && !$category3 && !$category4 && !$category5) {
            ?>
            <div class="bm-error"><?php echo esc_html__('Select Woocommerce Category', 'bigmart-elements'); ?></div>
            <?php
        } else {
            ?>
            <div class="bm-product-category-block2 <?php echo esc_attr($overlay_class); ?>" id="bm-product-category-block2-<?php echo esc_attr($this->get_id()); ?>" >
                <?php if ($category1) : ?>
    ...
    protected function get_product_category_content($category, $category_image) {
        ...
        if ($image['url']) {
            ...
            <a href="<?php echo esc_url(get_term_link($category)); ?>" class="cat-btn">
                ...
                <span class="ct-pcount"><?php echo esc_html($category->count); ?> <?php echo esc_html__('Products', 'bigmart-elements'); ?></span>
            </a>
            <?php
        }
    }

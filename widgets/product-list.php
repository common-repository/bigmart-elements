...
class Bigmart_Product_List_Widget extends Widget_Base {

    /** Widget Name * */
    public function get_name() {
        return 'bm-product-list';
    }

    /** Widget Title * */
    public function get_title() {
        return esc_html__('Product List', 'bigmart-elements');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'product_type', [
            'label' => __('Product Type', 'bigmart-elements'),
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .bm-product-list .product-list li .product-image' => 'width: {{SIZE}}{{UNIT}}; flex: 0 0 {{SIZE}}{{UNIT}}',
            ]
                ]
        );

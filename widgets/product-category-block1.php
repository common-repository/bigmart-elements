 ...
 */
class Bigmart_Product_Category_Block1_Widget extends Widget_Base {

    /** Widget Name */
    public function get_name() {
        return 'bm-product-category-block1-widget';
    }

    /** Widget Title */
    public function get_title() {
        return __('Product Category Grid 1', 'bigmart-elements');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
                'cat_btn_style', [
            'label' => __('Category Button', 'bigmart-elements'),
        ...
        $this->add_control(
                'cat_btn_bgcolor', [
            'label' => __('Background', 'bigmart-elements'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .bm-product-category-block1 .cat-btn' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .bm-product-category-block1 .cat-btn' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
                'cat_btn_color_hov', [
            'label' => __('Color(Hover)', 'bigmart-elements'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .bm-product-category-block1 .cat-btn:hover' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => '{{WRAPPER}} .bm-product-category-block1 .cat-btn',
                ]
        );
    ...
    protected function render() {
        ...
        if (!$category1 && !$category2 && !$category3 && !$category4) {
            ...
            ?>
            <div class="bm-product-category-block1" id="bm-product-category-block1-<?php echo esc_attr($this->get_id()); ?>" >
                <?php
                if ($category1) {
                    ?>

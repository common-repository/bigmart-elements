...
class Selectize_Control extends Base_Data_Control {
    ...
    const Selectize = 'bigmart-selectize';
    ...
    public function enqueue() {
        wp_enqueue_script('selectize', BMRT_PLUGIN_URI . 'inc/controls/assets/selectize.js', array('jquery', 'jquery-ui-sortable'), '1.0', true);
        wp_enqueue_script('custom-selectize', BMRT_PLUGIN_URI . 'inc/controls/assets/custom-selectize.js', array('selectize'), '1.0', true);
        wp_enqueue_style('selectize', BMRT_PLUGIN_URI . 'inc/controls/assets/selectize.css', array(), '');
    }

(function ($, elementor) {
    ...
    var BMRT = {
        init: function () {
            var widgets = {
                "bm-slider-widget.default": BMRT.Slider,
                "bm-product-tabs-grid.default": BMRT.Tabs,
                "bm-product-category-tab.default": BMRT.Tabs,
                "bm-countdown.default": BMRT.Countdown,
                "bm-testimonial-slider.default": BMRT.TestimonialSlider,
            };
        ...
        Slider: function ($scope) {
            var $element = $scope.find('.bm-slider');
            if ($element.length > 0) {
        ...
        Tabs: function ($scope) {
            var tabs = $scope.find(".bm-product-tabs-grid");
            ...
            if (tabs.length > 0) {
                tabs.each(function (index, tab) {
                    $(tab).find('.tabs li').click(function (e) {
                        ...
                        $(this).parents('.bm-product-tabs-grid').find('.products').removeClass('active');

                        $(this).addClass('active');
                        $(this).parents('.bm-product-tabs-grid').find('#' + id).addClass('active');
                    });
                });
            }
        },
        Countdown: function ($scope) {
            var countdowns = $scope.find(".bm-countdown");
        ...
        TestimonialSlider: function ($scope) {
            var tsliders = $scope.find(".bm-testimonial-slider");
    ...
    $(window).on("elementor/frontend/init", BMRT.init);
